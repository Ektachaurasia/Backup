...
class ServoConvert():
    def __init__(self, id, center_value, range=90, direction=1):
        self.value      = 0.0
...
class DkLowLevelCtrl():
    def __init__(self):
        ...
        self.actuators = {}
        self.actuators['throttle']  = ServoConvert(id=2, center_value = 350)
        self.actuators['steering']  = ServoConvert(id=1, center_value = 350, direction=1) #-- positive left
